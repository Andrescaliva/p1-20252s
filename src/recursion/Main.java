...
public class Main {
	...
	public static void main(String[] args) {
		/*int[] arreglo= {2,5,7,1,8,3};
		recursionArrays.imprimirRango(arreglo,2,4);
		System.out.print(recursionArrays.suma(arreglo));*/
		
		//System.out.println(recursionString.reverso("hola"));
		//System.out.println(recursionString.combinar("abd","bbc"));
		//System.out.println(recursionString.combinar("fgd", "adfxgtgs"));
		System.out.println(ejParcial.repetirLetras("cuando"));
